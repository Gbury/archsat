...
as in previous work by Degtyarev and Voronkov~\cite{degtyarev1996you}, but with
...
We write $s \approx t | \Sigma$ (resp. $s \not\approx t | \Sigma$),
...
We write $\emptyset | \Sigma$ for the empty clause under hypothesis $\Sigma$.
The E-unification problem $E \vdash s\approx t$ can be solved by
proving $\emptyset | \Sigma$
from $\{ (e | \{ \emptyset \}, e \in E \} \cup \{ s \not\approx t| \{ \emptyset \} \}$.
...
less general than $\sigma'$. We will first define a few notions.
