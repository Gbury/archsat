...
type _ Dispatcher.msg +=
  | Prove : Format.formatter * string * D.lemma_info -> unit Dispatcher.msg

module M = Msat.Coq.Make(Solver.Proof)(struct
...
let print_proof ~context fmt proof =
  ...
  if context then begin
    ...
    Format.fprintf fmt "Theorem goal : @[<hov>%a@].@\n" pp_goals goals;
